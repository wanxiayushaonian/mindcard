...
from app.api import activities, ai, api_keys, auth, cards, chat, comments, external, graph, insights, memories, notifications, rag, search, synthesis_templates, topics, topology, workspaces, ws
...
app.include_router(synthesis_templates.router, prefix="/api/workspaces", tags=["synthesis-templates"])
